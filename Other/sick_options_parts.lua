...
local floaty_mods= {
	...
	{ name= "Path Mods", meta= options_sets.menu,
		args= make_menu_of_float_set(path_mods) },
	{ name= "Miscelanious", meta= options_sets.menu,
		args= make_menu_of_float_set(tan_mods) },
